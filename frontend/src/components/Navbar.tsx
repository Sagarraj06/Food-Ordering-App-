        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
            ...
            <div className="flex items-center gap-4">
...

                {
                    ...
                    :<Link to={"/login"} className="font-medium text-[#E23744]">SignIn/SignUp</Link>
                }
            </div> 
        </div>
        {/* Search Bar */}
        {isHomePage && <div className="border-t px-4 py-3">
            <div className="mx-auto flex max-w-7xl items-center rounded-lg border shadow-sm">
                ...
                <div className="flex flex-1 items-center gap-2 px-3">
                    ...
                    <input type="text" placeholder="Search for restaurants" value={search} onChange={(e)=>setSearch(e.target.value)} className="w-full py-2 text-sm outline-none"/>
                </div>
            </div>
        </div>}
    </div>
